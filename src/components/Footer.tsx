  ...
  return (
    ...
    <section className="mb-[2em] flex border- w-[9em] justify-between  border-[red] mx-auto ">
      <p className="bg-[#C74817] p-5 h-[1em] w-[1em] rounded-full flex items-center justify-center   ">
         <FontAwesomeIcon icon={faFacebookF} className=' hover:ml-[0.8em] text-[white] ' />
      </p>
      <p className="bg-[#C74817] p-5 h-[1em] w-[1em] rounded-full flex items-center justify-center   ">
         <FontAwesomeIcon icon={faInstagram} className=' hover:ml-[0.8em] text-[white] ' />
      </p>
      <p className="bg-[#C74817] p-5 h-[1em] w-[1em] rounded-full flex items-center justify-center   ">
         <FontAwesomeIcon icon={faTwitter} className=' hover:ml-[0.8em] text-[white] ' />
      </p>   
    </section>
